...
libraryDependencies ++= Seq(
	...
	"net.tqft" %% "toolkit-base" % "0.1.19-SNAPSHOT",
	"net.tqft" %% "toolkit-amazon" % "0.1.19-SNAPSHOT",
	"net.tqft" %% "toolkit-permutations" % "0.1.19-SNAPSHOT",
	"net.tqft" %% "toolkit-algebra" % "0.1.19-SNAPSHOT",
	"net.tqft" %% "toolkit-algebra-principalgraphs" % "0.1.19-SNAPSHOT",
	"net.tqft" %% "toolkit-algebra-experimental" % "0.1.19-SNAPSHOT",
